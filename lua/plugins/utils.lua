...
map("n", "<leader>fd", function() require("fzf-lua").diagnostics_document() end,
    { desc = "Find Buffer Diagnostics" })
map("n", "<leader>fD", function() require("fzf-lua").diagnostics_workspace() end,
    { desc = "Find Workspace Diagnostics" })
map("n", "<leader>fw", function() require("fzf-lua").grep_cword() end, { desc = "Find Current Word" })
map("n", "<leader>fa", function() require("fzf-lua").lsp_code_actions() end, { desc = "Code Action" })
map("n", "<leader>ca", function() require("fzf-lua").lsp_code_actions() end, { desc = "Code Action" })
map("n", "<leader>fr", function() require("fzf-lua").lsp_references() end, { desc = "Find References" })
map("n", "<leader>fs", function() require("fzf-lua").lsp_document_symbols() end, { desc = "Find Symbols" })
map("n", "<leader>fS", function() require("fzf-lua").lsp_workspace_symbols() end,
    { desc = "Find Workspace Symbols" })
map("n", "<leader>fl", function() require("fzf-lua").lsp_finder() end, { desc = "Lsp Finder" })
map("n", "<leader>fu", function() require("fzf-lua").undotree() end, { desc = "Undotree" })
...
map("n", "<C-/>", "<esc>gcc", { desc = "Toggle Comment" })

require("mini.move").setup()     -- move line/selected up, down, right, left by alt

require("mini.surround").setup({ -- surround target with char
    mappings = {
...
autocmd("BufReadPre", {
    ...
    callback = function()
        ...
        map("n", "[h", function() require("gitsigns").prev_hunk() end, { desc = "Presious git hunk" })
